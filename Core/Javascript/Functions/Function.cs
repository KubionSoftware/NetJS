...
namespace NetJS.Core.Javascript {
    ...
    public abstract class Function : Object {
        ...
        public static Function FunctionInitialize(Function f, FunctionKind kind, ParameterList parameterList, Block body, LexicalEnvironment scope, Agent agent) {
            ...
            if (kind == Javascript.FunctionKind.Arrow) {
        ...
        public static Function FunctionCreate(FunctionKind kind, ParameterList parameterList, Block body, LexicalEnvironment scope, bool strict, Agent agent, Object prototype = null) {
            ...
            var allocKind = kind != Javascript.FunctionKind.Normal ? "non-constructor" : "normal";
        ...
        public Context PrepareForOrdinaryCall(Object newTarget, Agent agent) {
            ...
            var calleeContext = new Context(Realm);
