...
namespace NetJS.Core.API {
    class StringAPI {
        ...
        public static String GetString(Constant _this) {
            if (_this is String s) return s;
            return (_this as Object).Get(Primitive) as String;
        }
        ...
        public static Constant split(Constant _this, Constant[] arguments, Agent agent) {
            ...
            if (arguments.Length == 0) {
                ...
                if (arguments[0] is String) {
                    ...
                    return RegExpAPI.split(arguments[0], new Constant[] { GetString(_this) }, agent);
                }
        ...
        public static Constant match(Constant _this, Constant[] arguments, Agent agent) {
            return RegExpAPI.match(arguments[0], new Constant[] { GetString(_this) }, agent);
        }

        public static Constant search(Constant _this, Constant[] arguments, Agent agent) {
            return RegExpAPI.search(arguments[0], new Constant[] { GetString(_this) }, agent);
        }

        public static Constant test(Constant _this, Constant[] arguments, Agent agent) {
            return RegExpAPI.test(arguments[0], new Constant[] { GetString(_this) }, agent);
        }
