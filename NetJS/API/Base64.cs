...
namespace NetJS.API {
    public class Base64 {
        ...
        public static Constant decode(Constant _this, Constant[] arguments, Agent agent) {
            var value = ((Core.String)arguments[0]).Value;
            return new Core.String(Util.Base64.Decode(value));
        }
        ...
        public static Constant encode(Constant _this, Constant[] arguments, Agent agent) {
            var value = ((Core.String)arguments[0]).Value;
            return new Core.String(Util.Base64.Encode(value));
        }
    }
}