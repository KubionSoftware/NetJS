...
namespace NetJS.Internal {
    public class Math {
        ...
        public static Constant random(Constant _this, Constant[] arguments, Scope scope) {
            return new Javascript.Number(_random.NextDouble());
        }

        public static Constant floor(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant ceil(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant sin(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant sinh(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant cos(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant cosh(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant tan(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant tanh(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant asin(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant acos(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant atan(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant atan2(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant exp(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant abs(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant sqrt(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant pow(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant round(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant log(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant log10(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant max(Constant _this, Constant[] arguments, Scope scope) {
        ...
        public static Constant min(Constant _this, Constant[] arguments, Scope scope) {
            var numbers = new List<double>();
            for (var i = 0; i < arguments.Length; i++) {
