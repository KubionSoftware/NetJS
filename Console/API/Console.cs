...
namespace NetJS.Console.API {
    class Console {
        ...
        public static Constant writeLine(Constant _this, Constant[] arguments, LexicalEnvironment lex) {
            var text = NetJS.Core.Tool.GetArgument<NetJS.Core.Javascript.String>(arguments, 0, "Console.writeLine");
            System.Console.WriteLine(text);
            return Static.Undefined;
        }

        public static Constant readLine(Constant _this, Constant[] arguments, LexicalEnvironment lex) {
